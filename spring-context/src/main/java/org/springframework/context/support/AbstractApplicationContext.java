...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		...
		synchronized (this.startupShutdownMonitor) {
			...
			// >>>>>>>>>>>>DefaultListableBeanFactory 894 line end
	 ...
	 * 我们来总结一下，到目前为止，应该说 BeanFactory 已经创建完成，
	 * 并且所有的实现了 BeanFactoryPostProcessor 接口的 Bean 都已经初始化并且其中的
	 * postProcessBeanFactory(factory) 方法已经得到执行了。
	 * 所有实现了 BeanPostProcessor 接口的 Bean 也都完成了初始化。
	 *
